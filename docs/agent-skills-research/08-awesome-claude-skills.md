# Agent Skills Research - karanb192/awesome-claude-skills

**Source:** karanb192/awesome-claude-skills  
**Link:** https://github.com/karanb192/awesome-claude-skills  
**Type:** Curated List / Aggregator  
**Language:** N/A (Links to external skills)  
...
A community-maintained curated list of 50+ verified Claude Skills organized into 11 categories. Serves as a discovery resource for finding relevant skills across the ecosystem.
...
**Reason:** Valuable as a discovery resource for finding specific skills, not as a skill itself.
...
1. **Discovery:** Browse categories when looking for specific capabilities
2. **Validation:** Check if needed skill already exists
3. **Inspiration:** Use category structure for X4 skill organization
