...
1. Review each viable source in detail (Phase 2)
2. Create individual research reports
...
- This is a living document that will be updated as filtering progresses
- Quick pass should take 2-5 minutes per source
- Focus on identifying what the repository contains, not evaluating individual skills yet
- Detailed evaluation happens in Phase 2
